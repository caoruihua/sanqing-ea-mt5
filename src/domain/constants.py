...
# 禁止开仓时间段配置（小时为单位，使用24小时制）
# 每个时间段为 (开始小时, 结束小时) 的元组
# 注意：结束时间支持半小时，例如 19.5 表示 19:30
DEFAULT_TRADING_BLACKOUT_PERIODS = [
    (11.0, 14.0),    # 11:00 - 14:00
    (16.0, 19.5),    # 16:00 - 19:30
    (1.0, 7.0),      # 01:00 - 07:00
]

# 保护引擎参数
PROTECTION_STAGE1_ATR_MULTIPLIER = 1.0
PROTECTION_STAGE1_SL_BUFFER_ATR = 0.3
...
class RejectionReason:
    ...
    TRADING_BLACKOUT = "TRADING_BLACKOUT"
